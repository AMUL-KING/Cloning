...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			os.system("git clone https://github.com/AMUL-KING/Cloning.git")

			os.system("rm -rf Cloning.py")

			os.system("cp -f Cloning/Cloning.py \\.")

			os.system("rm -rf Cloning")
